...
/// <summary>Represents the result of a UPOS command execution.</summary>
...
public sealed record UposCommandResult(
    UposErrorCode ResultCode,
    int ExtendedCode = 0)
{
    /// <summary>Gets a successful command result.</summary>
    public static UposCommandResult Ok { get; } =
        new(UposErrorCode.Success);

    /// <summary>Gets a value indicating whether the command was successful.</summary>
    public bool IsSuccess =>
        ResultCode == UposErrorCode.Success;
}
